      ...
      <div className={style.container}>
        ...
        <div className={style.avis}>
          <div className={style.avis_wrapper}>
            <p>
              " Très heureux d'avoir collaboré avec Camille pour la création de
              mon site internet. Camille est très professionnel, réactif et a le
              sens du détail! "
            </p>
            <div className={style.redacteur}>
              ...
              <p className="label">- Demetis Conseil</p>
            </div>
          </div>
        </div>
      </div>
